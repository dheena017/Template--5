...
import {
  ...
  Terminal, Share2, Info, ChevronLeft
} from 'lucide-react'
    ...
    <div className="settings-modern-page">
      <aside className="settings-sidebar">
        <div className="sidebar-header">
          <button className="back-to-hub" onClick={() => navigate('/settings-hub')} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'inherit', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <ChevronLeft size={20} />
          </button>
      ...
      <main className="settings-main-area">
        <header className="main-header">
          ...
          <button className="reset-btn-top" onClick={() => navigate('/settings-hub')}>
