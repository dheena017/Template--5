...
import { Layers, Clock, ShieldCheck, Zap, Sparkles, AlertCircle } from 'lucide-react';
            ...
            >
                ...
                <div className="flex flex-col items-center text-center group">
                    <div className="upload-icon-wrapper">
                        <Layers size={48} style={{ color: activeTool.color }} />
                    </div>
                    ...
                    <div className="feature-pill-wrapper">
                        ...
                        <div className="feature-pill"><Zap size={16} /> <span>Drag & Drop</span></div>
                    </div>
                </div>
                {pdfLoading && (
                    <div className="loading-overlay">
                        <Sparkles className="w-16 h-16 animate-pulse mb-4" style={{ color: activeTool.color }} />
                        <p className="text-white font-black text-xl tracking-tight">Loading Pages...</p>
                    </div>
                )}
            </div>
        </motion.div>
