...
const SelectStep = ({ getRootProps, getInputProps, isDragActive, activeTool, fromFormat, toFormat }) => {
    return (
        <motion.div 
            ...
            className="select-step-container w-full PDF-conversion-card"
        >
            <div 
            ...
            >
                ...
                <div className="flex flex-col items-center text-center group">
                    <div className="upload-icon-wrapper">
                        <FileText size={48} style={{ color: activeTool.color }} />
                    </div>
                    <h3 className="text-2xl font-black text-white mb-2">{fromFormat} to {toFormat}</h3>
                    <p className="text-lg text-slate-400 mb-8 max-w-md">Drop your {fromFormat} PDF here or click to select from your device.</p>
                    <Button 
                        type="button" 
                        variant="primary" 
