...
import { Download, Languages, CheckCircle2 } from 'lucide-react';
...
const ResultStep = ({ resultData, fromFormat, toFormat, activeTool, reset }) => {
    return (
        <motion.div 
            ...
            className="p-12 text-center w-full max-w-4xl mx-auto Translation-conversion-card"
        >
            <div className="w-24 h-24 bg-green-500/10 rounded-[2rem] flex items-center justify-center mx-auto mb-8 border border-green-500/20 shadow-[0_0_40px_rgba(34,197,94,0.15)] relative overflow-hidden Translation-icon-container success">
            ...
            <p className="text-slate-400 mb-8 max-w-md mx-auto">
                Your Translation has been successfully converted from {fromFormat} to {toFormat}.
            </p>
            ...
            <div className="p-6 max-w-md mx-auto mb-10 flex items-center justify-between aura-card-inner success-file-box">
                ...
                <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: `${activeTool.color}20` }}>
                    <Languages size={24} style={{ color: activeTool.color }} />
                </div>
            </div>
