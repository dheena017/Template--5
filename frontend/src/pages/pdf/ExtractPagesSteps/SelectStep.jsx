...
import { FileOutput, Clock, ShieldCheck, Zap, Sparkles, AlertCircle } from 'lucide-react';
            ...
            >
                ...
                <div className="flex flex-col items-center text-center group">
                    <div className="upload-icon-wrapper">
                        <FileOutput size={48} style={{ color: activeTool.color }} />
                    </div>
                    <h3 className="text-2xl font-black text-white mb-2">Extract Pages?</h3>
                    <p className="text-lg text-slate-400 mb-8 max-w-md">Drop your PDF here and visually select only the specific pages you need to keep.</p>
                    <Button 
                        type="button" 
                        variant="primary" 
                    ...
                    <div className="feature-pill-wrapper">
                        <div className="feature-pill"><Clock size={16} /> <span>Visual Picker</span></div>
                        <div className="feature-pill"><ShieldCheck size={16} /> <span>Local-First</span></div>
                        <div className="feature-pill"><Zap size={16} /> <span>Instant Build</span></div>
                    </div>
                </div>
                {pdfLoading && (
