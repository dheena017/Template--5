...
import { Image, Settings2, Loader2, PlayCircle, HardDrive, Zap } from 'lucide-react';
                ...
                <div className="Image-file-card-header">
                    ...
                    <div className="flex-1 min-w-0 flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="Image-meta-badge" style={{ color: activeTool.color }}>{fromFormat} Image</span>
                        </div>
                    </div>
