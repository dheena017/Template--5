    ...
    return (
        <section className="pdf-pages-shell">
            <main className="pdf-pages-main p-8 md:p-12 w-full max-w-[1400px] mx-auto">
                <PDFToolSwitcher activeTool="PDF Intelligence" />
                <header className="pdf-pages-header mb-12 flex justify-between items-center bg-white/5 p-8 rounded-3xl border border-white/10">
                    ...
                    <label htmlFor="intel-search" className="pdf-pages-search relative w-96">
                        ...
                        <input
                            ...
                            className="w-full bg-black/40 border border-white/10 rounded-full py-4 pl-12 pr-6 text-white placeholder:text-slate-500 focus:outline-none focus:border-amber-500 transition-all font-bold"
                        />
                    </label>
                </header>
