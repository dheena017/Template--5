...
const ConvertToPDFSidebar = ({ activeTab, onTabChange }) => {
  const tools = [
    { id: 'word-to-pdf', label: 'Word to PDF', icon: <Icons.FileText /> },
    { id: 'jpg-to-pdf', label: 'JPG to PDF', icon: <Icons.ImageIcon /> },
    { id: 'excel-to-pdf', label: 'Excel to PDF', icon: <Icons.Table /> },
  ];
