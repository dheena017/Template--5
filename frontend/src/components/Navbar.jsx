...
const Icons = {
  ...
  Avatar: () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/></svg>,
  Image: () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>,
  Social: () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>,
  Dev: () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>,
...
const Navbar = ({ activeTab, onTabChange, onToggle }) => {
  const menuItems = [
    ...
    { id: 'developer-api-hub', icon: <Icons.Dev /> },
  ];

  return (
    <div className="aura-navbar">
      <button className="aura-nav-toggle" onClick={() => onTabChange('dashboard')}>
      ...
      <div className="aura-nav-footer">
         <div className="aura-nav-item" onClick={() => onTabChange('settings-hub')} style={{ marginBottom: '16px', color: 'rgba(255,255,255,0.4)', cursor: 'pointer' }}>
            <Icons.Settings />
         </div>
         <div className="user-avatar-mini" onClick={() => onTabChange('profile')}></div>
      </div>
    </div>
  );
};
